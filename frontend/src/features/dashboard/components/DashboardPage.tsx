	...
	},
	{
		...
		visual: (
			<svg width="80" height="34" viewBox="0 0 80 34">
				<rect x="0" y="20" width="7" height="14" rx="2" fill="var(--ember)" opacity="0.35" />
				<rect x="11" y="15" width="7" height="19" rx="2" fill="var(--ember)" opacity="0.5" />
				<rect x="22" y="8" width="7" height="26" rx="2" fill="var(--ember)" opacity="0.7" />
				<rect x="33" y="2" width="7" height="32" rx="2" fill="var(--ember)" opacity="0.95" />
				<rect x="44" y="10" width="7" height="24" rx="2" fill="var(--ember)" opacity="0.6" />
				<rect x="55" y="17" width="7" height="17" rx="2" fill="var(--ember)" opacity="0.4" />
				<rect x="66" y="23" width="7" height="11" rx="2" fill="var(--ember)" opacity="0.25" />
			</svg>
		),
	},
	{
				...
				<ul className="dash-task-list">
					{FOCUS_TASKS.map((task) => (
						<li className="dash-task-row" key={task.title}>
							...
							<span className={`chip chip-dot ${PRIORITY_CHIP[task.priority]}`}>
